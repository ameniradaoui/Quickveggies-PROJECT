...
public class JavaSMS {
	...
	public void setSmsServerProperties(List<String> receivers, String sms) {

		String msg = "test";
		String[] receiver = new String[] { "+91 7972509 759" };
		...
		// sbPostData.append("&country=" + country); // add this if country code
		// is missing
		// final string
