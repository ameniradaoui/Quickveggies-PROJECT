...
public class UpdateLadaanEntryController implements Initializable {
    ...
    final List<ExpenseInfo> expenseList = buyerDao.getBuyerExpenseInfoList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        commitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                dbc.updateTableEntry(tableName, UpdateLadaanEntryController.this.buyDealLineId, sqlNames,
                ...
                if (UpdateLadaanEntryController.this.ladBijDealLineId != -1) {
                	dbc.updateTableEntry("ladaanBijakSaleDeals", UpdateLadaanEntryController.this.ladBijDealLineId,
                    ...
                    dbc.saveEntryToSql("ladaanBijakSaleDeals", ladaanBijSqlNames, ladBijColValues);
                }
