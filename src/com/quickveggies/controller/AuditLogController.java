...
import com.quickveggies.dao.AuditDao;
...
public class AuditLogController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	...
    	ldo = BeanUtils.getBean(LadaanBijakDao.class);
    	...
    	auditDao = BeanUtils.getBean(AuditDao.class);
    	
        logLines.clear();
        List<AuditLog> logs = auditDao.getAuditRecords();
            ...
            if (log.getEventObject() != null && log.getEventObjectId() != null) {
                try {
                    switch (log.getEventObject()) 
                    {
                        case "partyMoney": 
                        {
                            MoneyPaidRecd value = mpd.getMoneyPaidRecd(log.getEventObjectId());
                            if (value != null) 
                            {
                                entryObject = value;
                                name = value.getTitle();
                        ...
                        case "arrival": 
                        {
                            DSalesTableLine value = dSalesDao.getSalesEntryLineFromSql(log.getEventObjectId());
                            if (value != null) 
                            {
                                entryObject = value;
                                name = value.getAgent();
                        ...
                        case "buyerDeals": 
                        {
                            DBuyerTableLine value = bd.getBuyerDealEntry(log.getEventObjectId());
                            if (value != null) 
                            {
                                entryObject = value;
                        ...
                        case "ladaanBijakSaleDeals": {
                            LadaanBijakSaleDeal value = ldo.getLadBijSaleDeal(log.getEventObjectId());
                            if (value != null) {
                                entryObject = value;
                        ...
                        case "supplierDeals": 
                        {
                            DSupplierTableLine value = supplierDao.getSupplierDealEntry(log.getEventObjectId());
                            if (value!= null) 
                            {
                                entryObject = value;
                        ...
                        case "accountEntries": {
                            AccountEntryLine value = accountEntryDao.getAccountEntryLine(log.getEventObjectId());
                            if (value != null) {
                                entryObject = value;
                                name = value.getPayee();
                        ...
                        case "accounts": 
                        {
                            Account value = accountEntryDao.getAccountById(log.getEventObjectId());
                            if (value != null) 
                            {
                                entryObject = value;
                        ...
                        case "expenditures": 
                        {
                            Expenditure value = ed.getExpenditureById(log.getEventObjectId());
                            if (value != null) 
                            {
                                entryObject = value;
                                name = value.getPayee();
    ...
    private String prepareBuyerDealPdf(DBuyerTableLine currDeal) {
        try {
            List<DBuyerTableLine> buyerDeals = bd.getBuyerDealEntries(currDeal.getBuyerTitle(), null);
            Integer cases = 0;
            ...
            List<ExpenseInfo> buyerExpenses = bd.getBuyerExpenseInfoList();
            String[][] dataArr = buildBuyerInvoicePdf(currDeal, buyerDeals, buyerExpenses);
            Buyer buyer = bd.getBuyerByName(currDeal.getBuyerTitle());
    ...
    private String prepareSupplierDealPdf(DSupplierTableLine currDeal) {
        try {
            ...
            Supplier supplier = supplierDao.getSupplierByName(currDeal.getSupplierTitle());
    ...
    private String prepareSalesDealPdf(DSalesTableLine currDeal) {
        try {
            ...
            Supplier supplier = supplierDao.getSupplierByName(currDeal.getSupplier());
