...
public class SessionDataController {
    ...
    public StorageBuyerDealDao storageDao ;
    public LadaanBijakDao lbd;
    ...
    protected SessionDataController() {
        ...
        storageDao = BeanUtils.getBean(StorageBuyerDealDao.class);
    }
    ...
    public void resetPendingColdStoreEntries() {
        int coldStorePending = storageDao.getStorageDealsCount("Cold Store");
        pendingColdStoreEntriesProp.setValue(String.valueOf(coldStorePending));
    }

    public void resetPendingGodownEntries() {
        int godownPending = storageDao.getStorageDealsCount("Godown");
