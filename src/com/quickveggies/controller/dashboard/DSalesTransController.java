...
public class DSalesTransController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            lines.clear();
            for (DSalesTableLine line : dSalesDao.getSalesEntries()) {
                lines.add(line);
            }
        }
  ...
  //test filter
    ...
    public static   String[][] buildInvTabForEmail(DSalesTableLine line) {
        ...
        try {
            salesDeals = dSalesTableDao.getSalesEntryLineBySupplierName(line.getSupplier());
            supplierLine = supplierDao.getSupplierDealEntries(line.getSupplier());
        ...
        List<Charge> suppCharges = chargesDao.getDealCharges(Integer.valueOf(dealId));
