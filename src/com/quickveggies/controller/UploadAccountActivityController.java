...
import com.quickveggies.dao.TemplateDao;
...
public class UploadAccountActivityController implements Initializable {
    ...
    private static  AccountEntryLineDao accountEntryDao;
    ...
    public void initialize(URL location, ResourceBundle resources) {
         ...
         td = BeanUtils.getBean(TemplateDao.class);
        ...
        chooseAccount.setOnAction((ActionEvent event) -> {
            ...
            // account
            try {
                Template template = td.getTemplate(chooseAccount.getValue());
        ...
        preview.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                filteredData = applyTemplateToXls(td.getTemplate(chooseAccount.getValue()),
        ...
        create.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                for (int rowInd = 1; rowInd < filteredData.length; rowInd++) {
                    ...
                    accountEntryDao.saveAccountEntryLine(entryline);
                }
                Account account =  accountEntryDao.getAccountByName(chooseAccount.getValue());
...
//                        new String[]{"" + currentTime}, false);
    ...
    public static boolean isAlreadyUploaded(String[][] xtractedTableData) {
        ...
        for (int rowInd = 1; rowInd <= maxSize; rowInd++) {
            boolean hasRecord =  accountEntryDao.hasAccountEntry(xtractedTableData[rowInd][dateColIdx], Utils.toDbl(xtractedTableData[rowInd][withdrawalColIdx]),
